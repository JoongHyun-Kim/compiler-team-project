...
function_header	: del_spec function_name formal_param	{ semantic(7); };
del_spec		: del_specifiers			{ semantic(8); };
del_specifiers	: del_specifier			{ semantic(9); }
		| del_specifiers del_specifier		{ semantic(10); };
del_specifier	: type_qualifier			{ semantic(11); }
...
opt_formal_param	: formal_param_list			{ semantic(18); }
		|				{ semantic(19); };
formal_param_list	: param_del			{ semantic(20); }
		| formal_param_list ',' param_del 	{ semantic(21); };
